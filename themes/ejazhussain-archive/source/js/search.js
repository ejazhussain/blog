...
(function ($) {
    ...
    var template = '<div id="u-search"><div class="modal"> <header class="modal-header" class="clearfix"><form id="u-search-modal-form" class="u-search-form" name="uSearchModalForm"> <input type="text" id="u-search-modal-input" class="u-search-input" autocomplete="off" /> <button type="submit" id="u-search-modal-btn-submit" class="u-search-btn-submit"><span class="icon is-left"> <i class="fas fa-search"></i> </span></button></form> <a class="btn-close"> <span class="icon icon-close"><i class="fa fa-times-circle"></i></span> </a><div class="modal-loading"><div class="modal-loading-bar"></div></div> </header> <main class="modal-body"><ul class="modal-results modal-ajax-content"></ul> </main> <footer class="modal-footer clearfix"><div class="modal-metadata modal-ajax-content"> <strong class="range"></strong> of <strong class="total"></strong></div><div class="modal-error"></div> <div class="logo"></div> <a class="nav btn-next modal-ajax-content"> <span class="text">NEXT</span> <span class="icon icon-chevron-right"></span> </a> <a class="nav btn-prev modal-ajax-content"> <span class="icon icon-chevron-left"></span> <span class="text">PREV</span> </a> </footer></div><div class="modal-overlay"></div></div>';
            ...
            if (!self.cache) {
                $.get(self.config.endpoint, {
                    ...
                    if (status !== 'success' ||
                        ...
                        if(!results.length > 0){
                            results = "<div id='no-result'><i class='fa fa-frown-o fa-5x'></i></div>";
                        }
                        self.dom.modal_results.html(results);
                    }
                    self.buildMetadata(data);
